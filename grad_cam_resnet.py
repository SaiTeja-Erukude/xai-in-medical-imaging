...
MODEL_PATH = "D:/Projects/XAI in Medical Imaging/models/resnet/resnet50_chest.h5"
TEST_DIR = "D:/Projects/XAI in Medical Imaging/data/chest/test"
OUTPUT_DIR = "D:/Projects/XAI in Medical Imaging/predictions/chest/resnet/grad_cam"
LAST_CONV_LAYER_NAME = "conv5_block3_out"

# Function to generate Grad-CAM heatmap
def make_gradcam_heatmap_resnet(img_array, model, last_conv_layer_name, pred_index=None):
    ...
    grad_model = tf.keras.models.Model(
        [resnet_base.input],
        [resnet_base.get_layer(last_conv_layer_name).output, resnet_base.output]
    )
    ...
    for fname in files:
        if fname.lower().endswith(('.png', '.jpg', '.jpeg')):
            ...
            try:
                ...
                # Generate heatmap
                heatmap = make_gradcam_heatmap_resnet(img_array, model, LAST_CONV_LAYER_NAME)
